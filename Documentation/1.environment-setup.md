...
**Note: the set up was primarily done on windows. However, the Kubernetes documentation offer a detailed insight in set up on a linux system.**
...
Usually, it is already configured by default. However, to [do that](https://docs.fedoraproject.org/en-US/Fedora/13/html/Virtualization_Guide/sect-Virtualization-Troubleshooting-Enabling_Intel_VT_and_AMD_V_virtualization_hardware_extensions_in_BIOS.html) 
 1. restart the computer
 2. press F4 or F12 or any of the System menu key to enter the Bios menu
 3. Seek for item named "Chipset, advanced CPU Configuration" or "Northbridge" or othem similar items on different Bios
...
Kubernetes allow deployment to cloud platforms 

kubeadm: (https://kubernetes.io/docs/setup/independent/install-kubeadm/)
    bootstrap a minimum kubernetes cluste
